...
_TOPICS = {
    ...
    "folder-timeline": HelpTopic(
        ...
        "Wertet einen relativen Ordnerpfad einschließlich Unterordnern chronologisch aus und zeigt Änderungen zum jeweils vorherigen Scan.",
        "Keine Änderung an Index oder Originaldateien. Nur ausdrücklich gewählte JSON-, CSV- oder HTML-Berichte werden erstellt.",
        "Sehr gering – SQLite wird ausschließlich lesend geöffnet.",
        "Wenn Wachstum, Rückgang, Verschwinden oder Wiederauftauchen eines Ordners über mehrere Scans nachvollzogen werden soll.",
        "datenbanktool index folder-timeline index.sqlite3 Musik --csv musik-verlauf.csv",
    ),
