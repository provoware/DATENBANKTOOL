...
- Türkis `#35e1dc` – primäre Aktion / Fokus
- Grün `#50e38a` – Erfolg
- Gelb `#ffd24a` – Hinweis / offen
- Rot `#ff667a` – Fehler / Blockade
- Lila `#8d7dff` – Information / Struktur

Farbe wird immer mit Text oder Symbol kombiniert.
