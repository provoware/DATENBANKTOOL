...
3. Auf **Fehlercode**, **Kurzursache** und **Tipp** achten.
4. Bei wiederholtem Fehler zusätzlich die passende `.jsonl`-Datei weitergeben.
...
- **Recovery** – Wiederherstellung nach Fehler oder Absturz.
- **Regression** – ein früher behobener Fehler taucht wieder auf.
